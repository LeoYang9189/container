...
const mockData = Array.from({ length: 20 }, (_, index) => ({
  id: `RWO${String(index + 1).padStart(6, '0')}`,
...
const RepairWorkOrderPage: React.FC = () => {
  ...
  // 新增工作单
  const handleAdd = () => {
    navigate('/smartainer/repair-management/create');
  };

  // 编辑工作单
  const handleEdit = (record: any) => {
    navigate(`/smartainer/repair-management/edit/${record.id}`);
  };
...
export default RepairWorkOrderPage; 